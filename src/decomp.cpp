...
void decomp::mem_alloc(lexer *p, dive *a)
{
    ...
    const int xsurf = 3*p->knoy*p->knoz*(a->mx);
    const int ysurf = 3*p->knox*p->knoz*(a->my);
    const int zsurf = 3*p->knox*p->knoy*(a->mz);
    ...
    a->Iarray(a->para1co,xco,4);
    a->Iarray(a->para2co,yco,4);
    a->Iarray(a->para3co,yco,4);
    a->Iarray(a->para4co,xco,4);
    a->Iarray(a->para5co,zco,4);
    a->Iarray(a->para6co,zco,4);
    ...
    a->Iarray(a->paracoslice1sf,xco,3);
    a->Iarray(a->paracoslice2sf,yco,3);
    a->Iarray(a->paracoslice3sf,yco,3);
    a->Iarray(a->paracoslice4sf,xco,3);
}
